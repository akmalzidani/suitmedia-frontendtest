    ...
    <div class="mx-auto w-full container p-4 py-6 lg:py-8">
      ...
      <div class="sm:flex sm:items-center sm:justify-between flex flex-wrap justify-center">
        ...
        <div class="flex mt-4 sm:justify-center sm:mt-0">
          ...
          <a href="https://github.com/akmalzidani" target="_blank" class="text-gray-500 hover:text-gray-900  ms-5">
            <svg class="w-4 h-4 fill-suitmedia-primary" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
          ...
          <a href="https://instagram.com/akmalzidani" target="_blank" class="text-gray-500 hover:text-gray-900  ms-5">
            <svg class="h-6 w-6" viewBox="0 6 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xml:space="preserve" xmlns:serif="http://www.serif.com/" style="fill-rule:evenodd;clip-rule:evenodd;stroke-linejoin:round;stroke-miterlimit:2;">
    <g>
        <clipPath id="_clip1">
